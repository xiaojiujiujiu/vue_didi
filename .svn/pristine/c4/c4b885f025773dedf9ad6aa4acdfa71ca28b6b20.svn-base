  ...
  .service('orderListServices', function ($http) {
    this.getClassify = function () {
      return [
        ...
        { name: '待派工',searchstatus:'120', viewable: false},
        { name: '待完工',searchstatus:'130', viewable: false},
        { name: '已完工',searchstatus:'140', viewable: false},
        { name: '已驳回',searchstatus:'150', viewable: false},
        { name: '异常单',searchstatus:'160', viewable: false},
      ]
    };
