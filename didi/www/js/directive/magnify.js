angular.module('starter.controllers', [])
  ...
  var comImageBox = {
    ...
    templateUrl: 'templates/comImageBox.html',
    transclude: false,
    templateNamespace: 'html',
    scope: false,
    link: {
      pre: function preLink(scope, element, attrs, controller) {
        scope.Url = "../www/img/ben.png";
        scope.Describe = '';
        scope.bigImage = false;

        //显示图片
        scope.showBigImage = function (imageName,imgDescribe) {
          scope.Url = imageName;
          scope.Describe = imgDescribe;
          scope.bigImage = true;

          console.log(imgDescribe);
          $(".LightBox").show(10,function () {
